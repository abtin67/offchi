    ...
    <>
      <div className="px-[8%] lg:px-[12%] py-10">
        <div className="title my-10 w-full flex flex-col lg:flex-row justify-between items-center">
          <h1 className="text-5xl">بهترین فروش‌های امروز</h1>
        </div>
        <div className="flex flex-col lg:flex-row items-start gap-5">
          <div className="w-full lg:w-2/3">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              {products.map((product) => (
                <div
                  key={product.id}
                  className="product-wrap flex flex-col sm:flex-row lg:flex-col border border-gray-300 rounded-lg
          ...
          <div className="w-full lg:w-1/3 rounded-2xl best-sale-banner flex flex-col justify-center items-center">
            <Image src={bestSaleBanner} alt="hot deals banner" />
            <h1 className="text-4xl text-black my-5">سبزیجات تازه</h1>
            <p className="text-center text-blue-900 font-semibold mb-3">
